...
export function Author() {
  return (
    <section
      ...
      className="relative scroll-mt-14 pb-3 pt-8 sm:scroll-mt-20 sm:pb-16 sm:pt-10 lg:pt-16"
    >
        ...
        <div className="bg-slate-50 pt-px sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-8 font-display text-5xl font-extrabold tracking-tight text-slate-900 sm:text-6xl">
              <span className="block text-blue-600">Carlitos Ct10 </span> Hola Soy el autor de un comienzo.
            </p>
            <p className="mt-4 text-lg tracking-tight text-slate-700">
              Esta pagina esta diseñada con todos los los requerimientos de ultima generacion.
              Esta pagina esta diseñada con todos los los requerimientos de ultima generacion
              Esta pagina esta diseñada con todos los los requerimientos de ultima generacion
              Esta pagina esta diseñada con todos los los requerimientos de ultima generacion
            </p>
